...
class sector_object:
    def __init__(self, uniqueID, LTE_Carrier_Count, CURRENT_BW, NEW_BW, scalar, volThreshold, prbThreshold, revenue):
        self.uniqueID = uniqueID
        self.LTE_Carrier_Count = LTE_Carrier_Count
        self.CURRENT_BW = CURRENT_BW
        self.NEW_BW = NEW_BW
        self.scalar = scalar
        self.volThreshold = volThreshold
        self.prbThreshold = prbThreshold
